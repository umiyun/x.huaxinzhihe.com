...
define('YOUMI_NAME', 'umi_activitys');

!defined('YOUMI_PATH') && define('YOUMI_PATH', IA_ROOT . '/addons/umi_activitys/');
...
!defined('YOUMI_URL') && define('YOUMI_URL', $_W['siteroot'] . 'addons/umi_activitys/');
!defined('YOUMI_URL_APP') && define('YOUMI_URL_APP', YOUMI_URL . 'template/mobile/');
!defined('YOUMI_URL_TEMP') && define('YOUMI_URL_TEMP', YOUMI_URL . 'template/');
