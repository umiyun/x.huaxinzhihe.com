...
define('UMIACP_NAME', 'umiacp_speeddial');
...
//        $data['receive_mobile'] = $from['receive_mobile'];
        ...
        $data['goimg'] = $from['goimg'];
        $data['sharenum'] = $from['sharenum'];
        ...
        if ($from['activity_id']) {
            ...
            pdo_delete(UMIACP_NAME . '_activity_prize', ['activity_id' => $item['activity_id']]);
