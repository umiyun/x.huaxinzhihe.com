...
define('YOUMI_NAME', 'umi_courseapply');

!defined('YOUMI_PATH') && define('YOUMI_PATH', IA_ROOT . '/addons/umi_courseapply/');
...
!defined('YOUMI_URL') && define('YOUMI_URL', $_W['siteroot'] . 'addons/umi_courseapply/');
