...
define('YOUMI_NAME', 'umiacp_apply');
define('UMI_NAME', 'umi_activitys');

!defined('YOUMI_PATH') && define('YOUMI_PATH', IA_ROOT . '/addons/umiacp_apply/');
...
!defined('YOUMI_URL') && define('YOUMI_URL', $_W['siteroot'] . 'addons/umiacp_apply/');
