<?php
pdo_query("
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_activity` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_cate` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_complain` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_cut` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_member` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_puv` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_puv_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_record` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家',
  `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_saler` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_apply_setting` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
