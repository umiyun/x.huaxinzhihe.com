<?php
//自己删除上面的符号
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_activity` (
...
if(!pdo_fieldexists('umiacp_bargain_activity','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_activity','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家'");}
if(!pdo_fieldexists('umiacp_bargain_activity','title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `title` varchar(255) NOT NULL COMMENT '标题'");}
if(!pdo_fieldexists('umiacp_bargain_activity','image')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `image` varchar(255) NOT NULL COMMENT '顶部主题'");}
if(!pdo_fieldexists('umiacp_bargain_activity','bgimage')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `bgimage` varchar(255) NOT NULL COMMENT '背景图'");}
if(!pdo_fieldexists('umiacp_bargain_activity','music')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `music` varchar(255) NOT NULL COMMENT '背景音乐'");}
if(!pdo_fieldexists('umiacp_bargain_activity','cutnum')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `cutnum` int(11) NOT NULL COMMENT '最多可参与几种商品砍价'");}
if(!pdo_fieldexists('umiacp_bargain_activity','starttime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `starttime` int(11) NOT NULL COMMENT '活动开始时间'");}
if(!pdo_fieldexists('umiacp_bargain_activity','endtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `endtime` int(11) NOT NULL COMMENT '活动结束时间'");}
if(!pdo_fieldexists('umiacp_bargain_activity','preferential_title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `preferential_title` varchar(255) NOT NULL COMMENT '活动优惠标题'");}
if(!pdo_fieldexists('umiacp_bargain_activity','preferential_val')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `preferential_val` text COMMENT '活动优惠内容'");}
if(!pdo_fieldexists('umiacp_bargain_activity','desc_title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `desc_title` varchar(255) NOT NULL COMMENT '活动描述标题'");}
if(!pdo_fieldexists('umiacp_bargain_activity','desc_imgs')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `desc_imgs` text COMMENT '活动描述图集'");}
if(!pdo_fieldexists('umiacp_bargain_activity','desc_val')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `desc_val` text COMMENT '活动描述内容'");}
if(!pdo_fieldexists('umiacp_bargain_activity','rule_title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `rule_title` varchar(255) NOT NULL COMMENT '活动规则标题'");}
if(!pdo_fieldexists('umiacp_bargain_activity','rule_val')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `rule_val` text COMMENT '活动规则内容'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_title` varchar(255) NOT NULL COMMENT '商家介绍标题'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_val')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_val` text COMMENT '商家介绍内容'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_imgs')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_imgs` text COMMENT '商家介绍图集'");}
if(!pdo_fieldexists('umiacp_bargain_activity','receive_time')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `receive_time` varchar(255) NOT NULL COMMENT '领取时间'");}
if(!pdo_fieldexists('umiacp_bargain_activity','receive_address')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `receive_address` varchar(255) NOT NULL COMMENT '领取地址'");}
if(!pdo_fieldexists('umiacp_bargain_activity','receive_mobile')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `receive_mobile` varchar(255) NOT NULL COMMENT '联系电话'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_name')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_name` varchar(255) NOT NULL COMMENT '商家姓名'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_mobile')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_mobile` varchar(255) NOT NULL COMMENT '商家热线'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_province')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_province` varchar(255) NOT NULL COMMENT '省'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_city')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_city` varchar(255) NOT NULL COMMENT '市'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_district')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_district` varchar(255) NOT NULL COMMENT '区'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_address')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_address` varchar(255) NOT NULL COMMENT '商家详细地址'");}
if(!pdo_fieldexists('umiacp_bargain_activity','userinfo')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `userinfo` text COMMENT '用户信息收集'");}
if(!pdo_fieldexists('umiacp_bargain_activity','pv')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `pv` int(11) NOT NULL DEFAULT '0' COMMENT '查看人数'");}
if(!pdo_fieldexists('umiacp_bargain_activity','share')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `share` int(11) NOT NULL DEFAULT '0' COMMENT '分享人数'");}
if(!pdo_fieldexists('umiacp_bargain_activity','participate')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `participate` int(11) NOT NULL DEFAULT '0' COMMENT '参与人数'");}
if(!pdo_fieldexists('umiacp_bargain_activity','success')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `success` int(11) NOT NULL DEFAULT '0' COMMENT '成功人数'");}
if(!pdo_fieldexists('umiacp_bargain_activity','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态:1,上架;2,下架;3,未开始;'");}
if(!pdo_fieldexists('umiacp_bargain_activity','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间'");}
if(!pdo_fieldexists('umiacp_bargain_activity','effects_imgs')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `effects_imgs` text COMMENT '特效图集'");}
if(!pdo_fieldexists('umiacp_bargain_activity','titlebgimg')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `titlebgimg` varchar(255) DEFAULT NULL COMMENT '标题背景框'");}
if(!pdo_fieldexists('umiacp_bargain_activity','share_img')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `share_img` varchar(255) DEFAULT NULL COMMENT '分享图'");}
if(!pdo_fieldexists('umiacp_bargain_activity','share_title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `share_title` varchar(255) DEFAULT NULL COMMENT '分享标题'");}
if(!pdo_fieldexists('umiacp_bargain_activity','share_desc')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `share_desc` varchar(255) DEFAULT NULL COMMENT '分享描述'");}
if(!pdo_fieldexists('umiacp_bargain_activity','regional')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `regional` int(11) NOT NULL DEFAULT '1' COMMENT '区域限制:1不限制;2限制;'");}
if(!pdo_fieldexists('umiacp_bargain_activity','r_address')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `r_address` text COMMENT '活动区域限制地区'");}
if(!pdo_fieldexists('umiacp_bargain_activity','ak')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `ak` varchar(255) DEFAULT NULL COMMENT '百度密钥'");}
if(!pdo_fieldexists('umiacp_bargain_activity','shop_code')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `shop_code` varchar(255) DEFAULT NULL COMMENT '商家图片（二维码）'");}
if(!pdo_fieldexists('umiacp_bargain_activity','cutting_pay')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   `cutting_pay` tinyint(4) NOT NULL DEFAULT '1' COMMENT '允许砍价中付款:1.允许;2.不允许'");}
if(!pdo_fieldexists('umiacp_bargain_activity','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   PRIMARY KEY (`id`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_activity','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   KEY `uniacid` (`uniacid`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_activity','title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_activity')." ADD   KEY `title` (`title`) USING BTREE");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_cate` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('umiacp_bargain_cate','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_cate','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_cate','rank')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   `rank` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_cate','cate_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   `cate_id` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_cate','title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   `title` varchar(255) NOT NULL COMMENT '分类名'");}
if(!pdo_fieldexists('umiacp_bargain_cate','logo')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   `logo` varchar(255) NOT NULL COMMENT '分类logo'");}
if(!pdo_fieldexists('umiacp_bargain_cate','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态'");}
if(!pdo_fieldexists('umiacp_bargain_cate','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间'");}
if(!pdo_fieldexists('umiacp_bargain_cate','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   PRIMARY KEY (`id`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_cate','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cate')." ADD   KEY `uniacid` (`uniacid`) USING BTREE");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_complain` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('umiacp_bargain_complain','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_complain','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_complain','activity_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动'");}
if(!pdo_fieldexists('umiacp_bargain_complain','shop_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家'");}
if(!pdo_fieldexists('umiacp_bargain_complain','reason')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `reason` varchar(255) NOT NULL DEFAULT '0' COMMENT '投诉原因'");}
if(!pdo_fieldexists('umiacp_bargain_complain','desc')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `desc` varchar(255) NOT NULL COMMENT '投诉描述'");}
if(!pdo_fieldexists('umiacp_bargain_complain','mobile')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `mobile` varchar(255) NOT NULL COMMENT '手机号'");}
if(!pdo_fieldexists('umiacp_bargain_complain','userinfo')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `userinfo` varchar(255) DEFAULT NULL COMMENT '具体用户信息'");}
if(!pdo_fieldexists('umiacp_bargain_complain','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '发起时间'");}
if(!pdo_fieldexists('umiacp_bargain_complain','title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   `title` varchar(255) DEFAULT NULL COMMENT '活动标题'");}
if(!pdo_fieldexists('umiacp_bargain_complain','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   PRIMARY KEY (`id`)");}
if(!pdo_fieldexists('umiacp_bargain_complain','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   KEY `uniacid` (`uniacid`)");}
if(!pdo_fieldexists('umiacp_bargain_complain','realname')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_complain')." ADD   KEY `realname` (`desc`,`mobile`) USING BTREE");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_cut` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('umiacp_bargain_cut','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_cut','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_cut','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `mid` int(11) NOT NULL DEFAULT '0' COMMENT '砍价人'");}
if(!pdo_fieldexists('umiacp_bargain_cut','activity_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动'");}
if(!pdo_fieldexists('umiacp_bargain_cut','shop_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家'");}
if(!pdo_fieldexists('umiacp_bargain_cut','goods_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品'");}
if(!pdo_fieldexists('umiacp_bargain_cut','oprice')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `oprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '原价'");}
if(!pdo_fieldexists('umiacp_bargain_cut','nprice')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `nprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '现价'");}
if(!pdo_fieldexists('umiacp_bargain_cut','rprice')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `rprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '底价'");}
if(!pdo_fieldexists('umiacp_bargain_cut','price')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '砍价'");}
if(!pdo_fieldexists('umiacp_bargain_cut','times')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `times` int(11) NOT NULL DEFAULT '0' COMMENT '剩余砍价次数'");}
if(!pdo_fieldexists('umiacp_bargain_cut','realname')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `realname` varchar(255) NOT NULL COMMENT '姓名'");}
if(!pdo_fieldexists('umiacp_bargain_cut','mobile')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `mobile` varchar(255) NOT NULL COMMENT '手机号'");}
if(!pdo_fieldexists('umiacp_bargain_cut','userinfo')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `userinfo` text COMMENT '具体用户信息'");}
if(!pdo_fieldexists('umiacp_bargain_cut','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态:1,砍价中;2,砍到底;3,已购买;'");}
if(!pdo_fieldexists('umiacp_bargain_cut','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '发起时间'");}
if(!pdo_fieldexists('umiacp_bargain_cut','lottery_time')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `lottery_time` int(11) NOT NULL DEFAULT '0' COMMENT '核销时间'");}
if(!pdo_fieldexists('umiacp_bargain_cut','avatar')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   `avatar` varchar(255) NOT NULL");}
if(!pdo_fieldexists('umiacp_bargain_cut','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   PRIMARY KEY (`id`)");}
if(!pdo_fieldexists('umiacp_bargain_cut','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   KEY `uniacid` (`uniacid`)");}
if(!pdo_fieldexists('umiacp_bargain_cut','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   KEY `mid` (`mid`)");}
if(!pdo_fieldexists('umiacp_bargain_cut','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   KEY `status` (`status`)");}
if(!pdo_fieldexists('umiacp_bargain_cut','realname')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_cut')." ADD   KEY `realname` (`realname`,`mobile`) USING BTREE");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('umiacp_bargain_goods','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_goods','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_goods','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户'");}
if(!pdo_fieldexists('umiacp_bargain_goods','activity_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动'");}
if(!pdo_fieldexists('umiacp_bargain_goods','shop_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家'");}
if(!pdo_fieldexists('umiacp_bargain_goods','title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `title` varchar(255) NOT NULL COMMENT '商品名'");}
if(!pdo_fieldexists('umiacp_bargain_goods','image')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `image` varchar(255) NOT NULL COMMENT '商品主图'");}
if(!pdo_fieldexists('umiacp_bargain_goods','oprice')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `oprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '原价'");}
if(!pdo_fieldexists('umiacp_bargain_goods','gnum')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `gnum` int(11) NOT NULL DEFAULT '0' COMMENT '数量'");}
if(!pdo_fieldexists('umiacp_bargain_goods','rprice')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `rprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '底价'");}
if(!pdo_fieldexists('umiacp_bargain_goods','times')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `times` int(11) NOT NULL DEFAULT '0' COMMENT '砍价次数'");}
if(!pdo_fieldexists('umiacp_bargain_goods','desc')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `desc` varchar(255) NOT NULL COMMENT '商品描述'");}
if(!pdo_fieldexists('umiacp_bargain_goods','participate')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `participate` int(11) NOT NULL DEFAULT '0' COMMENT '参与人数'");}
if(!pdo_fieldexists('umiacp_bargain_goods','success')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `success` int(11) NOT NULL DEFAULT '0' COMMENT '购买成功'");}
if(!pdo_fieldexists('umiacp_bargain_goods','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态:1,启用;0,禁用;'");}
if(!pdo_fieldexists('umiacp_bargain_goods','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '下单时间'");}
if(!pdo_fieldexists('umiacp_bargain_goods','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   PRIMARY KEY (`id`)");}
if(!pdo_fieldexists('umiacp_bargain_goods','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   KEY `uniacid` (`uniacid`)");}
if(!pdo_fieldexists('umiacp_bargain_goods','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   KEY `mid` (`mid`)");}
if(!pdo_fieldexists('umiacp_bargain_goods','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_goods')." ADD   KEY `status` (`status`)");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('umiacp_bargain_log','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_log','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_log','user_type')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `user_type` tinyint(3) NOT NULL DEFAULT '0' COMMENT '类型:1,后台;2,公众号;3,小程序;'");}
if(!pdo_fieldexists('umiacp_bargain_log','uid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `uid` int(11) NOT NULL DEFAULT '0' COMMENT '用户uid'");}
if(!pdo_fieldexists('umiacp_bargain_log','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户mid'");}
if(!pdo_fieldexists('umiacp_bargain_log','username')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `username` varchar(50) NOT NULL COMMENT '操作员昵称'");}
if(!pdo_fieldexists('umiacp_bargain_log','op')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `op` varchar(255) NOT NULL COMMENT '操作位置'");}
if(!pdo_fieldexists('umiacp_bargain_log','content')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `content` varchar(255) NOT NULL COMMENT '具体操作'");}
if(!pdo_fieldexists('umiacp_bargain_log','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '操作时间'");}
if(!pdo_fieldexists('umiacp_bargain_log','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   PRIMARY KEY (`id`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_log','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   KEY `uniacid` (`uniacid`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_log','type')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   KEY `type` (`user_type`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_log','uid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_log')." ADD   KEY `uid` (`uid`) USING BTREE");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_member` (
...
if(!pdo_fieldexists('umiacp_bargain_member','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD 
  `mid` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_member','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_member','openid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `openid` varchar(255) NOT NULL COMMENT '用户'");}
if(!pdo_fieldexists('umiacp_bargain_member','wxopenid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `wxopenid` varchar(255) NOT NULL COMMENT '小程序'");}
if(!pdo_fieldexists('umiacp_bargain_member','fmid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `fmid` tinyint(11) NOT NULL DEFAULT '0' COMMENT '推荐人'");}
if(!pdo_fieldexists('umiacp_bargain_member','realname')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `realname` varchar(255) NOT NULL COMMENT '姓名'");}
if(!pdo_fieldexists('umiacp_bargain_member','mobile')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `mobile` varchar(255) NOT NULL COMMENT '手机号'");}
if(!pdo_fieldexists('umiacp_bargain_member','password')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `password` varchar(255) NOT NULL COMMENT '密码'");}
if(!pdo_fieldexists('umiacp_bargain_member','salt')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `salt` varchar(255) NOT NULL COMMENT '秘钥'");}
if(!pdo_fieldexists('umiacp_bargain_member','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `status` tinyint(3) NOT NULL COMMENT '状态:1,;2,;'");}
if(!pdo_fieldexists('umiacp_bargain_member','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '注册时间'");}
if(!pdo_fieldexists('umiacp_bargain_member','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   PRIMARY KEY (`mid`)");}
if(!pdo_fieldexists('umiacp_bargain_member','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   KEY `uniacid` (`uniacid`)");}
if(!pdo_fieldexists('umiacp_bargain_member','openid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   KEY `openid` (`openid`,`wxopenid`)");}
if(!pdo_fieldexists('umiacp_bargain_member','mobile')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   KEY `mobile` (`mobile`)");}
if(!pdo_fieldexists('umiacp_bargain_member','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_member')." ADD   KEY `status` (`status`)");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家',
...
if(!pdo_fieldexists('umiacp_bargain_order','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_order','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_order','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户'");}
if(!pdo_fieldexists('umiacp_bargain_order','shop_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家'");}
if(!pdo_fieldexists('umiacp_bargain_order','activity_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动'");}
if(!pdo_fieldexists('umiacp_bargain_order','goods_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `goods_id` int(11) NOT NULL COMMENT '商品'");}
if(!pdo_fieldexists('umiacp_bargain_order','cut_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `cut_id` int(11) NOT NULL DEFAULT '0' COMMENT '砍价'");}
if(!pdo_fieldexists('umiacp_bargain_order','title')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `title` varchar(255) NOT NULL COMMENT '商品名'");}
if(!pdo_fieldexists('umiacp_bargain_order','ordersn')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `ordersn` varchar(255) NOT NULL COMMENT '订单号'");}
if(!pdo_fieldexists('umiacp_bargain_order','tid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `tid` varchar(255) NOT NULL COMMENT '商户订单号'");}
if(!pdo_fieldexists('umiacp_bargain_order','price')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '金额'");}
if(!pdo_fieldexists('umiacp_bargain_order','pay_time')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `pay_time` int(11) NOT NULL DEFAULT '0' COMMENT '支付时间'");}
if(!pdo_fieldexists('umiacp_bargain_order','transid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `transid` varchar(255) NOT NULL COMMENT '微信支付单号'");}
if(!pdo_fieldexists('umiacp_bargain_order','saler_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `saler_id` int(11) NOT NULL DEFAULT '0' COMMENT '核销员'");}
if(!pdo_fieldexists('umiacp_bargain_order','saler_openid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `saler_openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('umiacp_bargain_order','salertime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `salertime` int(11) NOT NULL DEFAULT '0' COMMENT '核销时间'");}
if(!pdo_fieldexists('umiacp_bargain_order','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态:1,待支付;2,已支付;3,已核销;4,已取消;5,申请退款;6,已退款;'");}
if(!pdo_fieldexists('umiacp_bargain_order','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '下单时间'");}
if(!pdo_fieldexists('umiacp_bargain_order','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   PRIMARY KEY (`id`)");}
if(!pdo_fieldexists('umiacp_bargain_order','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   KEY `uniacid` (`uniacid`)");}
if(!pdo_fieldexists('umiacp_bargain_order','tid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   KEY `tid` (`tid`)");}
if(!pdo_fieldexists('umiacp_bargain_order','ordersn')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   KEY `ordersn` (`ordersn`)");}
if(!pdo_fieldexists('umiacp_bargain_order','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_order')." ADD   KEY `status` (`status`)");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_puv` (
...
if(!pdo_fieldexists('umiacp_bargain_puv','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_puv','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_puv','page')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   `page` varchar(255) NOT NULL COMMENT '页面'");}
if(!pdo_fieldexists('umiacp_bargain_puv','goods_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品'");}
if(!pdo_fieldexists('umiacp_bargain_puv','pv')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   `pv` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '总浏览人次'");}
if(!pdo_fieldexists('umiacp_bargain_puv','uv')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   `uv` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '总浏览人数'");}
if(!pdo_fieldexists('umiacp_bargain_puv','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   `createtime` int(11) NOT NULL COMMENT '总访问时间'");}
if(!pdo_fieldexists('umiacp_bargain_puv','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   PRIMARY KEY (`id`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_puv','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   KEY `uniacid` (`uniacid`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_puv','page')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   KEY `page` (`page`)");}
if(!pdo_fieldexists('umiacp_bargain_puv','goods_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv')." ADD   KEY `goods_id` (`goods_id`)");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_puv_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=5419 DEFAULT CHARSET=utf8;

";
$sql_str=str_replace('ims_', $GLOBALS['_W']['config']['db']['tablepre'], $sql_str);
pdo_query($sql_str);

if(!pdo_fieldexists('umiacp_bargain_puv_record','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   `uniacid` int(11) NOT NULL");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','openid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   `openid` varchar(50) NOT NULL");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','goods_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '访问商品'");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','page')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   `page` varchar(50) NOT NULL COMMENT '访问页面'");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','input')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   `input` text COMMENT '用户输入'");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '访问时间'");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   PRIMARY KEY (`id`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   KEY `uniacid` (`uniacid`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','openid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   KEY `openid` (`openid`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','page')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   KEY `page` (`page`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_puv_record','goods_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_puv_record')." ADD   KEY `goods_id` (`goods_id`)");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_record` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家',
  `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动',
...
if(!pdo_fieldexists('umiacp_bargain_record','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_record','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_record','shop_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家'");}
if(!pdo_fieldexists('umiacp_bargain_record','activity_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动'");}
if(!pdo_fieldexists('umiacp_bargain_record','goods_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品'");}
if(!pdo_fieldexists('umiacp_bargain_record','cut_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `cut_id` int(11) NOT NULL DEFAULT '0' COMMENT '砍价'");}
if(!pdo_fieldexists('umiacp_bargain_record','fmid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `fmid` int(11) NOT NULL DEFAULT '0' COMMENT '发起人'");}
if(!pdo_fieldexists('umiacp_bargain_record','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `mid` int(11) NOT NULL DEFAULT '0' COMMENT '砍价人'");}
if(!pdo_fieldexists('umiacp_bargain_record','oprice')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `oprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '原价'");}
if(!pdo_fieldexists('umiacp_bargain_record','nprice')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `nprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '现价'");}
if(!pdo_fieldexists('umiacp_bargain_record','price')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '砍价'");}
if(!pdo_fieldexists('umiacp_bargain_record','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态:1,砍价中;2,砍到底;'");}
if(!pdo_fieldexists('umiacp_bargain_record','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '砍价时间'");}
if(!pdo_fieldexists('umiacp_bargain_record','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   PRIMARY KEY (`id`)");}
if(!pdo_fieldexists('umiacp_bargain_record','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   KEY `uniacid` (`uniacid`)");}
if(!pdo_fieldexists('umiacp_bargain_record','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   KEY `mid` (`mid`)");}
if(!pdo_fieldexists('umiacp_bargain_record','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_record')." ADD   KEY `status` (`status`)");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_saler` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
...
if(!pdo_fieldexists('umiacp_bargain_saler','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_saler','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_saler','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户'");}
if(!pdo_fieldexists('umiacp_bargain_saler','openid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `openid` varchar(255) NOT NULL");}
if(!pdo_fieldexists('umiacp_bargain_saler','shop_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家'");}
if(!pdo_fieldexists('umiacp_bargain_saler','realname')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `realname` varchar(255) NOT NULL COMMENT '姓名'");}
if(!pdo_fieldexists('umiacp_bargain_saler','mobile')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `mobile` varchar(255) NOT NULL COMMENT '电话'");}
if(!pdo_fieldexists('umiacp_bargain_saler','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态:1,启用;0,禁用;'");}
if(!pdo_fieldexists('umiacp_bargain_saler','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间'");}
if(!pdo_fieldexists('umiacp_bargain_saler','activity_id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   `activity_id` int(11) NOT NULL COMMENT '活动id'");}
if(!pdo_fieldexists('umiacp_bargain_saler','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   PRIMARY KEY (`id`)");}
if(!pdo_fieldexists('umiacp_bargain_saler','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   KEY `uniacid` (`uniacid`)");}
if(!pdo_fieldexists('umiacp_bargain_saler','mid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   KEY `mid` (`mid`)");}
if(!pdo_fieldexists('umiacp_bargain_saler','status')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_saler')." ADD   KEY `status` (`status`)");}
$sql_str="CREATE TABLE IF NOT EXISTS  `ims_umiacp_bargain_setting` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
if(!pdo_fieldexists('umiacp_bargain_setting','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_setting')." ADD 
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('umiacp_bargain_setting','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_setting')." ADD   `uniacid` int(11) NOT NULL DEFAULT '0'");}
if(!pdo_fieldexists('umiacp_bargain_setting','skey')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_setting')." ADD   `skey` varchar(255) NOT NULL COMMENT '键'");}
if(!pdo_fieldexists('umiacp_bargain_setting','svalue')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_setting')." ADD   `svalue` text COMMENT '值'");}
if(!pdo_fieldexists('umiacp_bargain_setting','createtime')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_setting')." ADD   `createtime` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间'");}
if(!pdo_fieldexists('umiacp_bargain_setting','id')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_setting')." ADD   PRIMARY KEY (`id`) USING BTREE");}
if(!pdo_fieldexists('umiacp_bargain_setting','uniacid')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargain_setting')." ADD   KEY `uniacid` (`uniacid`) USING BTREE");}
...
if(!pdo_fieldexists('umiacp_bargainsimple_activity','cutting_pay')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargainsimple_activity')." ADD   `cutting_pay` tinyint(4) NOT NULL DEFAULT '1' COMMENT '允许砍价中付款:1.允许;2.不允许'");}
...
if(!pdo_fieldexists('umiacp_bargainsimple_cut','lottery_time')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargainsimple_cut')." ADD   `lottery_time` int(11) NOT NULL DEFAULT '0' COMMENT '核销时间'");}
if(!pdo_fieldexists('umiacp_bargainsimple_cut','avatar')) {pdo_query("ALTER TABLE ".tablename('umiacp_bargainsimple_cut')." ADD   `avatar` varchar(255) NOT NULL");}
