...
if ($op == 'display') {
    ...
    $success1 = pdo_fetchcolumn("SELECT COUNT(*) FROM " . tablename('umiacp_bargainsimple_order') . ' where uniacid=:uniacid and activity_id=:activity_id and status=2', [':uniacid' => $uniacid, ':activity_id' => $activity['id']]);
