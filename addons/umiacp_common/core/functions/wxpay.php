...
class WeixinPayCommon
{
    ...
    function __construct($appid, $openid, $mch_id, $key, $out_trade_no, $body, $total_fee,$_W)
    {
    ...
    private function unifiedorder()
    {
        ...
        $parameters = array(
            ...
            'notify_url' => $this->_W['siteroot'] . 'payment/wechat/notify.php',          //通知地址  确保外网能正常访问
            'openid' => $this->openid,                                              //用户id
            'trade_type' => 'JSAPI'                                                 //交易类型
        );

        youmi_internal_log('parameters', $parameters,$this->_W['uniacid']);
        ...
        youmi_internal_log('unifiedorder_return', $return,$this->_W['uniacid']);
    ...
    private static function postXmlCurl($xml, $url, $second = 30)
    {
        ...
        if ($data) {
            ...
            $error = curl_errno($ch);
            curl_close($ch);
            throw new WxPayExceptionCommon("curl出错，错误码:$error");
        }
    }
