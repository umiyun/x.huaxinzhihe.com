<?php
pdo_query("
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_activity` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_activity_prize` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_cate` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_complain` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_cut` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_member` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_prize_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `openid` varchar(255) NOT NULL COMMENT '用户',
  `realname` varchar(255) NOT NULL COMMENT '姓名',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_puv` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_puv_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_record` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家',
  `activity_id` int(11) NOT NULL DEFAULT '0' COMMENT '活动',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_reward` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_saler` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_eggfreny_setting` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
