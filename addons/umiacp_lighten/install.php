<?php
$sql_str="
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_activity` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_cate` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_complain` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_cut` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_goods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_member` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
  `shop_id` int(11) NOT NULL DEFAULT '0' COMMENT '商家',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_puv` (
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_puv_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_record` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_saler` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `mid` int(11) NOT NULL DEFAULT '0' COMMENT '用户',
 ...
 CREATE TABLE IF NOT EXISTS  `ims_umiacp_lighten_setting` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
